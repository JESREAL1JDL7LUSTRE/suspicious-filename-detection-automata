...
REM Check if target exists and warn if it might be locked
if exist "%TARGET%" (
    echo ⚠️  WARNING: %TARGET% already exists. If it's running, the build may fail.
    echo    Please close the program before rebuilding if you encounter errors.
    echo.
)
